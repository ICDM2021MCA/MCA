...
from madry import madry_loss
from utils import AverageMeter


parser = argparse.ArgumentParser(description='PyTorch MNIST MADRY Adversarial Training')
...
parser.add_argument('--model-dir', default='./model-mnist-smallCNN/MADRY',
...
def main():
    # settings
    model_dir = os.path.join(args.model_dir, 'madry')
